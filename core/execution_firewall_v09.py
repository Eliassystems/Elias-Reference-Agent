...
class CommitGateRefusedV09(Exception):
...
class ExecutionFirewallV09:
    ...
    def __init__(
        ...
        *,
        ...
        caller_identity_attestation_verifier: CallerIdentityAttestationVerifier,
        ...
        self.caller_identity_attestation_verifier = (
    ...
    @staticmethod
    def _caller_identity_details(
        *,
        caller_identity_attestation: CallerIdentityAttestation | None,
        authenticated_caller_agent_id: str | None,
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "caller_identity_attestation_id":
                (
                    caller_identity_attestation.attestation_id
                    if caller_identity_attestation is not None
                    else None
                ),

            "caller_identity_issuer_id":
                (
                    caller_identity_attestation.issuer_id
                    if caller_identity_attestation is not None
                    else None
                ),

            "caller_identity_attestation_subject_agent_id":
                (
                    caller_identity_attestation.subject_agent_id
                    if caller_identity_attestation is not None
                    else None
                ),
        }
    ...
    def _verify_caller_identity(
        ...
        *,
        ...
        validation = (
            self.caller_identity_attestation_verifier.verify(
                attestation=
        ...
        if not validation.valid:
            return (
                validation,
                (
                    "CALLER_IDENTITY_ATTESTATION_INVALID",
                    *validation.reasons,
                ),
            )

        authenticated_caller_agent_id = (
            validation.authenticated_subject_agent_id
        )

        if (
            authenticated_caller_agent_id
            != presenting_agent_id
            or authenticated_caller_agent_id
            != permit.agent_id
        ):
            return (
                validation,
    ...
    def _caller_attestation_has_completed_execution(
        self,
        attestation_id: str,
    ) -> bool:
    ...
    def _refuse(
        ...
        *,
        ...
        presenting_agent_id: str,
        reasons: Tuple[str, ...],
        caller_identity_attestation: CallerIdentityAttestation | None = None,
        authenticated_caller_agent_id: str | None = None,
    ...
    def execute(
        ...
        *,
        ...
        initial_caller_validation, caller_reasons = (
            self._verify_caller_identity(
                permit=permit,
                presenting_agent_id=
                    presenting_agent_id,
                caller_identity_attestation=
        ...
        if caller_reasons:
            return self._refuse(
                ...
                presenting_agent_id=
                    presenting_agent_id,
                authority=current_authority,
                reasons=caller_reasons,
                caller_identity_attestation=
                    caller_identity_attestation,
                authenticated_caller_agent_id=
                    initial_caller_validation
        ...
        if self._caller_attestation_has_completed_execution(
            caller_identity_attestation.attestation_id
        ):
            return self._refuse(
                permit=permit,
        ...
        boundary_caller_validation, boundary_caller_reasons = (
            self._verify_caller_identity(
                permit=permit,
                presenting_agent_id=
                    presenting_agent_id,
        ...
        if boundary_caller_reasons:
            return self._refuse(
                ...
                authority=
                    execution_authority,
                reasons=
                    boundary_caller_reasons,
                caller_identity_attestation=
                    caller_identity_attestation,
                authenticated_caller_agent_id=
                    boundary_caller_validation
                    .authenticated_subject_agent_id,
                prior_receipt_hashes=(
                    pre["receipt_hash"],
                ),
        ...
        boundary_authenticated_caller_agent_id = (
            boundary_caller_validation
            .authenticated_subject_agent_id
        )
        ...
        commit_authenticated_caller_agent_id = (
            boundary_authenticated_caller_agent_id
        )
        ...
        def commit_gate() -> AuthorityState:
            ...
            nonlocal commit_authenticated_caller_agent_id

            if commit_gate_used:
                raise CommitGateRefusedV09(
                    authority=
                        _post_authority(),
                    reasons=(
            ...
            commit_caller_validation, commit_caller_reasons = (
                self._verify_caller_identity(
                    permit=permit,
                    presenting_agent_id=
                        presenting_agent_id,
            ...
            commit_authenticated_caller_agent_id = (
                commit_caller_validation
                .authenticated_subject_agent_id
            )

            if commit_caller_reasons:
                raise CommitGateRefusedV09(
                    authority=
                        candidate_authority,
                    reasons=
                        commit_caller_reasons,
                )
        ...
        except CommitGateRefusedV09 as exc:
