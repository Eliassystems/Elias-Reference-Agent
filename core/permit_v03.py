...
@dataclass(frozen=True)
class PermitValidationV03:
    valid: bool
    reasons: Tuple[str, ...]


class PermitIssuerV03:
...
class PermitVerifierV03:
    ...
    def verify(
        ...
        *,
        ...
        expected_agent_id = expected_agent_id.strip()

        if not expected_agent_id:
            reasons.append(
                "EXPECTED_AGENT_ID_MISSING"
            )
        ...
        if permit.agent_id != expected_agent_id:
            reasons.append(
