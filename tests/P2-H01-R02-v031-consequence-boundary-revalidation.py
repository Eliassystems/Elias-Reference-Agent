...
EVIDENCE_DIR = Path(
    "evidence/phase-ii/p2-h01/remediation-002"
)

RESULT_PATH = (
    EVIDENCE_DIR
    / "P2-H01-R02-FIRST-OBSERVED-RESULT-001.json"
)

LEDGER_PATH = (
    EVIDENCE_DIR
    / "P2-H01-R02-WITNESS-001.jsonl"
)
...
signing_key = (
    b"P2-H01-R02-DETERMINISTIC-SIGNING-KEY-00000001"
)
...
objective = (
    "P2-H01-R02 deterministic consequence "
...
arguments = {
    "content":
        "P2-H01-R02 consequence payload"
}
...
evidence = {
    ...
    "nonclaim":
        (
            ...
            "P2-H01-R02. It does not establish "
