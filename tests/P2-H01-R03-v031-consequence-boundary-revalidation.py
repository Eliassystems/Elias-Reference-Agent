...
PERMISSION = "SEND"
POLICY_VERSION = "P2-H01-R03-001"

TARGET = "p2-h01-r03@example.test"
TOOL = "MESSAGING_DEMO"
CONSEQUENCE_CLASS = "EXTERNAL_WRITE"

EVIDENCE_DIR = Path(
    "evidence/phase-ii/p2-h01/remediation-003"
)

RESULT_PATH = (
    EVIDENCE_DIR
    / "P2-H01-R03-FIRST-OBSERVED-RESULT-001.json"
)

LEDGER_PATH = (
    EVIDENCE_DIR
    / "P2-H01-R03-WITNESS-001.jsonl"
)
...
signing_key = (
    b"P2-H01-R03-DETERMINISTIC-SIGNING-KEY-00000001"
)
...
objective = (
    "P2-H01-R03 deterministic consequence "
...
arguments = {
    "content":
        "P2-H01-R03 consequence payload"
}
...
evidence = {
    ...
    "nonclaim":
        (
            ...
            "P2-H01-R03. It does not establish "
